...
Если бы у меня был выбор, то использовал бы одного вендора как по железу, так и по виртуализации, контейнеризации,
а так же, оркестрации.
Но в текущих реалиях не уверен, что такое вообще возможно.
